...
GET  /v3/stores/{store_id}/public/products/count
GET  /v3/stores/{store_id}/public/products/{slug}
GET  /v3/stores/{store_id}/public/bundle-price-options
GET  /v3/stores/{store_id}/public/bundle-price-options/count
...
1. Muat katalog dengan `GET /public/products`, `GET /public/bundle-price-options`, `GET /public/categories`, dan route detail.
