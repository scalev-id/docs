...
Setelah `createOrder` berhasil, pilih redirect setelah order sendiri. Runtime hanya membuat order; runtime tidak menjalankan pengaturan Builder **After Submit Event** untuk kamu. Lihat [Aksi setelah order HTML Mode](/id/aksi-setelah-order-html-mode).
