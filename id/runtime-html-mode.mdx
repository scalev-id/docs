...
const paymentOptions = [
  ...
  ...bankTransferAccounts.map((account) => ({
    type: "bank_transfer",
    paymentAccountUniqueId: account.unique_id,
    label: `${account.account_holder} - ${account.account_number}`,
  })),
];
```
