...
Pasang pixel analytics yang sudah ada ke page display dengan mengirim ID record pixel Scalev di payload display. Ini adalah ID record numerik di Scalev, bukan kode pixel dari provider seperti Meta Pixel ID.
