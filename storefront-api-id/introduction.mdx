...
GET  /v3/stores/{store_id}/public/discount-codes/check
```
...
7. Opsional, validasi kode diskon dengan `GET /public/discount-codes/check?code=...`. Kode yang tidak dikenal atau tidak memenuhi syarat mengembalikan `is_eligible: false`; route hanya mengembalikan `404` jika store tidak ditemukan.
