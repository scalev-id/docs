...
Gunakan hanya metode payment yang dikembalikan oleh `GET /v3/stores/{store_id}/public/payment-methods`. Storefront API v3 tidak mengembalikan `no_payment`, dan endpoint checkout akan menolaknya jika dikirim langsung.
