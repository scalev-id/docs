...
Scalev MCP exposes five tools:

- `get_me`: shows the connected user, OAuth app, businesses, and permission context.
- `get_docs`: reads Scalev Developers documentation bundled into MCP from every page under the Developers tab in the docs navigation when the assistant cannot browse `docs.scalev.com`.
