...
<Update label="May 2026" description="Storefront API bundle price option catalog endpoints" tags={["API", "Docs"]}>
  Storefront API v3 now exposes canonical public catalog endpoints for bundle
  price options: `GET /v3/stores/{store_id}/public/bundle-price-options`,
  `GET /v3/stores/{store_id}/public/bundle-price-options/count`, and
  `GET /v3/stores/{store_id}/public/bundle-price-options/{slug}`. The old v3
  public bundle detail name is no longer part of the Storefront API contract.
</Update>
