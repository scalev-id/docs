...
<Update label="May 2026" description="Browser-only Storefront API build guide" tags={["Docs", "API"]}>
  Added an end-to-end Storefront API guide for agents and frontend developers
  building a browser-only storefront. The guide covers the direct browser
