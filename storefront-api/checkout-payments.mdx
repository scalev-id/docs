...
Use only payment methods returned by `GET /v3/stores/{store_id}/public/payment-methods`. Storefront API v3 does not return `no_payment`, and checkout endpoints reject it if submitted directly.
